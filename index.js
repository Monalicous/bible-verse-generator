...
function pullVerse(event) {
    ...
    let prompt = "Your assignment is to generate a full verse from the bible, name the book, chapter number as well as the verse number in the title, write the information in HTML format and do not diplay the html tags, add the Verse AI signature at the end in a <strong> tag";
